...
description: "For which n does n divide the nth Fibonacci number? A simple-sounding question with no clean answer."
date: 2025-08-11
weight: 1
...
def plot_fibonacci_cycles(m, cycles, equal_points):
    ...
    for ep in equal_points:
        plt.plot(ep, ep, 'ro', markersize=5, label=f'α({ep}) = {ep}')
