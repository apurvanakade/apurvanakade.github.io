...
description: "My new favorite proof of Sperner's lemma: morph the vertices toward the cardinal colors and let the determinant do the work."
author: Apurva Nakade
date: 2025-05-25
weight: 1
categories: [triangles, coloring, visualization, interactive, determinant]
image: "../../maths/images/sperner-geo.png"
---

This is my new favorite proof of [Sperner's lemma](sperners-lemma-statement.qmd). 
...
getFillColor = vertexColors => {
  ...
  if (fillColorGroups.group2.has(key)) {
    return 'rgba(255, 99, 71, 0.5)' // Tomato red
  }
