...
description: "Randomness is hard to simulate. How to generate a uniformly random point inside a triangle, worked out so I could play with Sperner's lemma."
author: Apurva Nakade
date: 2025-05-12
weight: 1
categories: [randomness, triangles]
image: "../../maths/images/random-points-triangle.png"
---
...
Next, we use the [barycentric transformation](barycentric-coordinates.qmd) to transform the standard triangle into the desired triangle—in the example above, the equilateral triangle with vertices $[0, 0], [1, 0], [0.5, \sqrt{3}/2]$.
