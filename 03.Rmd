...
I show that the technique of manifold calculus cannot be used to analyze the space of isosymplectic embeddings of symplectic manifolds.
This thesis also provides a big class of examples of non-analytic embedding functors in the sense of manifold calculus.
...
During my undergrad, I briefly worked on a project analyzing protein folding models using basic linear algebra.  We show that the mixing time of the Metropolis algorithm is not a decreasing function of the value of gap between the lowest and the second lowest energies.
