...
### Monte Carlo Methods
  ...
  ![](https://upload.wikimedia.org/wikipedia/commons/d/d4/Pi_monte_carlo_all.gif){width=50%}

  [Monte Carlo Methods Course Notes](https://apurvanakade.github.io/Monte-Carlo-Methods/)
...
![](https://apurvanakade.github.io/2026-Summer-Mathcamp-LeastSquares/index_files/figure-html/cell-2-output-1.png)

[Notes.](https://apurvanakade.github.io/2026-Summer-Mathcamp-LeastSquares/)

My attempt at teaching a week-long class at Mathcamp 2026 on the least squares method and its connection to the normal distribution inspired by Gauss' calculation of Ceres' orbit.
The prerequisites are basic calculus with a little bit of linear algebra and probability theory.




### Lean at MC2020
![](https://upload.wikimedia.org/wikipedia/commons/d/dc/Lean_logo2.svg){width=50%}
